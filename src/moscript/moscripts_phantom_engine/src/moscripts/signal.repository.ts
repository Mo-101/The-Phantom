...
import type { NormalizedSignal } from "./signal.schemas.js";
import { asNeo4jInt, fromNeo4jInt } from "./neo4j.util.js";
...
class SignalRepository {
  ...
  getBaselineSignals(nodeId: string, baselineWeeks: number): Record<string, unknown>[] {
    throw new Error("Method not implemented.");
  }
